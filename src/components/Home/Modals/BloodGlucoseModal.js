  ...
  return (
    <div className="modal-relative">
      ...
      <div className="modal-flex">
        <div className="header">Blood Glucose (mg/dL)</div>
        <div className="body">
            <div className="time-period-banner">Last 24 Hrs</div>
            <div className="modal-img fda-img-wrapper">
                <img src={require("../../../theme/assets/blood-glucose.png")} alt="blood glucose graph" />
            </div>
            <div className="bp-readings">
                <div className="bp-reading"  onClick={() => highlightMetric(1)}>
                    <div className="reading-info">Jan 1, 7:41 AM - Blood Glucose Monitor</div>
                    <div className={isActive1 ? 'reading-measurement red' : 'reading-measurement'}>88 mg/dL</div>
                </div>
                <div className="bp-reading" onClick={() => highlightMetric(2)}>
                    <div className="reading-info">Jan 1, 1:52 PM - Blood Glucose Monitor</div>
                    <div className={isActive2 ? 'reading-measurement red' : 'reading-measurement'}>326 mg/dL</div>
                </div>
                <div className="bp-reading" onClick={() => highlightMetric(3)}>
                    <div className="reading-info">Jan 1, 3:37 PM - Blood Glucose Monitor</div>
                    <div className={isActive3 ? 'reading-measurement red' : 'reading-measurement'}>46 mg/dL</div>
                </div>
            </div>
        </div>
      </div>
