  ...
  return (
    <div className="modal-relative">
      ...
      <div className="modal-flex">
        <div className="header">FDA Information - Lorazepam</div>
        <div className="body fda-img">
          <div className="fda-img-wrapper modal-img">
            <img
              src={require("../../../theme/assets/lorazepam-fda-info.jpg")}
              alt="Lorazepam fda drug information"
            />
          </div>
        </div>
      </div>
