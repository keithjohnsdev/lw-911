const GabapentinModal = (props) => {
    return (
      <div className="modal-relative">
        ...
        <div className="modal-flex">
          <div className="header">FDA Information - Gabapentin</div>
          <div className="body fda-img">
            <div className="fda-img-wrapper modal-img">
              <img
                src={require("../../../theme/assets/gabapentin-fda-info.jpg")}
                alt="Gabapentin fda drug information"
              />
            </div>
          </div>
        </div>
  ...
  export default GabapentinModal;
