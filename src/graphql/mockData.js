export const mockPatientViewData = {
  ...
  export const mockVitalsData = [
    {title: "Blood Pressure (mmHg)", value: "167/94", lastReading: "Today, 11:08 AM"},
    {title: "Heart Rate (bpm)", value: "84", lastReading: "Today, 11:34 AM"},
    {title: "Blood Glucose (mg/dL)", value: "104", lastReading: "Today, 5:55 PM"}
  ];
  ...
  export const mockMedicalIssuesData = [
    {title: "Tinnitus", status: "Active", doctor: "Dr. James Peters", date: "Jan 1, 1990"}
  ]
